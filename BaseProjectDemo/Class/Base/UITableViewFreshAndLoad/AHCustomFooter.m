...
- (void)placeSubviews
{
    ...
    self.logo.center = CGPointMake(DEVICE_SCREEN_WIDTH/2-35, self.mj_h * 0.5);
    if (_logo.isHidden) {
        self.label.center = CGPointMake(DEVICE_SCREEN_WIDTH/2, self.mj_h * 0.5);
    }else{
...
- (void)setState:(MJRefreshState)state
{
    ...
    switch (state) {
        ...
        case MJRefreshStateRefreshing:
        {
            ...
            [self.label sizeToFit];
            self.label.frame = self.bounds;
            self.logo.center = CGPointMake(DEVICE_SCREEN_WIDTH/2-18, self.mj_h * 0.5);
