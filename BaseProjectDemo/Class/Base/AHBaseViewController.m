...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = UIColorFromHEX(0xecedef);
    ...
    //添加导航栏分割线
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, self.navigationController.navigationBar.height - 0.5, DEVICE_SCREEN_WIDTH, 0.5)];
...
-(void)setBarTintColor:(UIColor*)color barStyle:(UIBarStyle)barStyle{
